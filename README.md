...
* [walkinglabs/learn-harness-engineering](https://github.com/walkinglabs/learn-harness-engineering) ⭐ 15,250 | 🐛 16 | 🌐 TypeScript | 📅 2026-08-26 - A project-based course repository on making Codex and Claude Code more reliable, centered on an Electron personal knowledge base app with lecture handouts, example artifacts, and practical harness projects.
* [hardness1020/awesome-agent-architecture](https://github.com/hardness1020/awesome-agent-architecture) ⭐ 936 | 🐛 4 | 🌐 Python | 📅 2026-09-11 - Trilingual architecture notes and runnable demos covering agent loops, tool execution, memory, permissions, context delivery, and orchestration.
...
* [DevProjex](https://github.com/Avazbek22/DevProjex) ⭐ 24 | 🐛 13 | 🌐 C# | 📅 2026-09-15 - GUI, TUI, and CLI tooling for selecting and exporting structured codebase context with folder trees, token estimates, ignore rules, and previews.
...
* [OpenViking](https://github.com/volcengine/OpenViking) ⭐ 37,469 | 🐛 739 | 🌐 Python | 📅 2026-09-15 - Context database that unifies agent memory, knowledge retrieval, and skills behind an MCP-accessible storage layer.
* [wiki](https://github.com/plasma-ai/wiki) ⭐ 92 | 🐛 2 | 🌐 Python | 📅 2026-09-04 - Indexed Markdown knowledge bases that give agents incremental project context through deterministic indexes, scoped CLI access, and merge handling for parallel edits.
* [Data Olympus](https://github.com/knaisoma/data-olympus) ⭐ 25 | 🐛 19 | 🌐 Python | 📅 2026-09-15 - Git-native project knowledge base and MCP server with governed proposal-to-acceptance workflows, validity windows, supersession chains, and retrieval of in-force engineering guidance.
...
* [APort Agent Guardrails](https://github.com/aporthq/aport-agent-guardrails) ⭐ 25 | 🐛 3 | 🌐 Shell | 📅 2026-09-15 - Deterministic pre-action authorization hooks for AI-agent tool calls, with adapters for Claude Code, Cursor, OpenClaw, LangChain, CrewAI, and related runtimes.
...
* [AGENTS.md](https://github.com/agentsmd/agents.md) ⭐ 24,387 | 🐛 176 | 🌐 TypeScript | 📅 2026-09-10 - A lightweight open format for repo-local instructions that tell agents how to work inside a codebase.
...
* [GitHub Spec Kit](https://github.com/github/spec-kit) ⭐ 136,994 | 🐛 322 | 🌐 Python | 📅 2026-09-15 - GitHub's toolkit for spec-driven development, useful when you want agents to execute against explicit product and engineering specs.
* [Context Repository-Driven Development (CRDD)](https://github.com/qual-lab/CRDD) ⭐ 0 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-15 - A repository-centered methodology for preserving product intent, decisions, specifications, evidence, and traceability as durable context while keeping approval authority with humans.
...
* [Better Harness](https://github.com/QoderAI/better-harness) ⭐ 2,279 | 🐛 9 | 🌐 JavaScript | 📅 2026-09-15 - Reviewer for coding-agent workflows that turns repository and session evidence into prioritized, verifiable harness improvements while keeping unobserved behavior explicit.
...
* [AgentOps](https://github.com/AgentOps-AI/agentops) ⭐ 5,819 | 🐛 181 | 🌐 Python | 📅 2026-06-25 - Open-source Python SDK for agent monitoring, session replay, cost tracking, benchmarking, and tracing across common LLM and agent frameworks.
...
* [WebArena-Verified](https://github.com/ServiceNow/webarena-verified) ⭐ 58 | 🐛 14 | 🌐 Python | 📅 2026-03-08 - A verified web-agent benchmark with curated tasks and deterministic evaluators over agent responses and captured network traces, making it a good fit for measuring web-facing harnesses.
...
* [AgentBench](https://github.com/THUDM/AgentBench) ⭐ 3,735 | 🐛 77 | 🌐 Python | 📅 2026-02-08 - A cross-environment benchmark spanning OS, databases, knowledge graphs, web browsing, and more, useful for seeing whether a harness generalizes beyond one narrow task loop.
* [tau2-bench](https://github.com/sierra-research/tau2-bench) ⭐ 2,042 | 🐛 210 | 🌐 Python | 📅 2026-09-11 - A benchmark for realistic, multi-step agent tasks where success depends on tool use and execution quality rather than a single-shot answer.
...
* [TravelPlanner](https://github.com/OSU-NLP-Group/TravelPlanner) ⭐ 546 | 🐛 2 | 🌐 Python | 📅 2026-05-24 - A benchmark for evaluating LLM agents on tool use and complex planning within multiple constraints, revealing how harness design handles multi-constraint satisfaction and long-horizon planning.
...
* [WildClawBench](https://github.com/InternLM/WildClawBench) ⭐ 522 | 🐛 5 | 🌐 Python | 📅 2026-08-17 - An in-the-wild benchmark running agents inside a live OpenClaw environment on 60 original tasks including multimodal, long-horizon, and safety-critical scenarios, making harness robustness under real-world conditions directly visible.
...
* [AgentKit](https://github.com/inngest/agent-kit) ⭐ 930 | 🐛 49 | 🌐 TypeScript | 📅 2026-04-29 - Inngest's TypeScript toolkit for building durable, workflow-aware agents on top of event-driven infrastructure.
...
* [BitRouter](https://github.com/bitrouter/bitrouter) ⭐ 226 | 🐛 35 | 🌐 Rust | 📅 2026-09-15 - Apache-2.0 model router with cross-protocol routing, MCP gateway, guardrails, observability, virtual keys, and multi-account failover.
* [DSH Studio](https://github.com/Moresyl/dsh-studio) ⭐ 27 | 🐛 0 | 🌐 Rust | 📅 2026-09-15 - Cross-platform desktop host for DeepSeek Harness with health probes, restart backoff, collision-free ports, and whole-process-tree cleanup.
...
* [Harbor](https://github.com/harbor-framework/harbor) ⭐ 5,270 | 🐛 874 | 🌐 Python | 📅 2026-09-15 - A generalized harness for evaluating and improving agents at scale, released alongside Terminal-Bench 2.0.
* [SWE-ReX](https://github.com/SWE-agent/SWE-ReX) ⭐ 591 | 🐛 55 | 🌐 Python | 📅 2026-09-14 - Sandboxed code execution infrastructure for AI agents, useful when harness work starts to merge into execution runtime design.
...
* [deepagents](https://github.com/langchain-ai/deepagents) ⭐ 29,449 | 🐛 196 | 🌐 Python | 📅 2026-09-15 - LangChain's open-source project for building deeper, longer-running agents with middleware and harness patterns.
* [SWE-agent](https://github.com/SWE-agent/SWE-agent) ⭐ 20,334 | 🐛 111 | 🌐 Python | 📅 2026-09-14 - A mature research coding agent that makes the harness, prompt, tools, and environment design directly inspectable.
* [Citadel](https://github.com/SethGammon/Citadel) ⭐ 923 | 🐛 4 | 🌐 JavaScript | 📅 2026-09-14 - A harness for Claude Code and OpenAI Codex with isolated worktrees, multi-agent coordination, and persisted memory and campaign state.
* [LoopTroop](https://github.com/looptroop-ai/LoopTroop) ⭐ 143 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-15 - Local-first GUI harness for long-running coding work with multi-model planning, isolated worktrees, and fresh-context recovery loops.
* [OpenCode Agent Orchestration Kit](https://github.com/jcarlosrodicio/opencode-agent-orchestration-kit) ⭐ 113 | 🐛 4 | 🌐 JavaScript | 📅 2026-09-07 - Reproducible OpenCode harness with role-based agents, explicit handoffs, repo-local skills, safe installation, and mechanical contract validation.
* [Agent AFK](https://github.com/griffinwork40/agent-afk) ⭐ 56 | 🐛 44 | 🌐 TypeScript | 📅 2026-09-15 - Headless coding-agent harness for asynchronous runs with explicit terminal states, editable lifecycle hooks, permission gates, model routing, and append-only traces.
...
* [forge-harness](https://github.com/chrono-meta/forge-harness) ⭐ 14 | 🐛 2 | 🌐 Shell | 📅 2026-09-15 - Claude Code plugin for adversarial validation, source-grounding audits, session-learning capture, and pre-deployment transfer simulation.
...
* [Orkas](https://github.com/Orkas-AI/Orkas) ⭐ 1,987 | 🐛 12 | 🌐 TypeScript | 📅 2026-09-15 - Local-first desktop harness for coordinating multiple agents with shared files, independent work contexts, human approval gates, and resumable execution.
* [Agentlas OS](https://github.com/agentlas-ai/Agentlas-OS) ⭐ 1,111 | 🐛 1 | 🌐 Python | 📅 2026-09-13 - Local-first agent operation environment that composes specialist teams while retaining host-local tools, permissions, memory boundaries, and verification rules.
* [Cowork Forge](https://github.com/sopaco/cowork-forge) ⭐ 93 | 🐛 0 | 🌐 Rust | 📅 2026-08-25 - MIT-licensed multi-agent software-development workflow with specialized roles and a staged pipeline from requirements through delivery.
...
* [browser-use/browser-harness](https://github.com/browser-use/browser-harness) ⭐ 17,567 | 🐛 345 | 🌐 Python | 📅 2026-09-12 - A thin CDP-based browser harness that lets agents extend helper functions during execution, useful for inspecting self-healing web-task workflows.
* [BrowserAct](https://github.com/browser-act/skills) ⭐ 5,929 | 🐛 8 | 🌐 Python | 📅 2026-08-24 - Open-source browser automation layer for agents with isolated parallel sessions, multi-account operation, and human handoff when automation is blocked.
...
* [codex-profiles](https://github.com/Ducksss/codex-profiles) ⭐ 149 | 🐛 1 | 🌐 Shell | 📅 2026-09-15 - Codex CLI and Desktop profile launcher that isolates authentication, configuration, sessions, connectors, plugins, and logs by `CODEX_HOME`.
...
* [Build A Harness](https://github.com/3IVIS/buildaharness) ⭐ 12 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-14 - Apache-2.0 visual canvas for agent harnesses that compiles a runtime-neutral FlowSpec to several orchestration frameworks.
* [stelow](https://github.com/calionauta/stelow) ⭐ 11 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-15 - Agentic product-workflow harness with Shape Up boundaries, adversarial plan review, acceptance-based execution contracts, and audit loops.
