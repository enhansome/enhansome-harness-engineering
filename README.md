...
* [GitHub Spec Kit](https://github.com/github/spec-kit) ⭐ 130,018 | 🐛 329 | 🌐 Python | 📅 2026-08-18 - GitHub's toolkit for spec-driven development, useful when you want agents to execute against explicit product and engineering specs.
* [AGENTS.md](https://github.com/agentsmd/agents.md) ⭐ 23,707 | 🐛 169 | 🌐 TypeScript | 📅 2026-03-12 - A lightweight open format for repo-local instructions that tell agents how to work inside a codebase.
...
* [AgentOps](https://github.com/AgentOps-AI/agentops) ⭐ 5,781 | 🐛 176 | 🌐 Python | 📅 2026-06-25 - Open-source Python SDK for agent monitoring, session replay, cost tracking, benchmarking, and tracing across common LLM and agent frameworks.
* [agenttrace](https://github.com/luoyuctl/agenttrace) ⭐ 120 | 🐛 8 | 🌐 Rust | 📅 2026-08-17 - Local-first TUI/CLI for auditing AI coding-agent session traces, health gates, cost spikes, tool failures, latency gaps, and attempt-to-attempt diffs.
...
* [tau2-bench](https://github.com/sierra-research/tau2-bench) ⭐ 1,815 | 🐛 172 | 🌐 Python | 📅 2026-08-14 - A benchmark for realistic, multi-step agent tasks where success depends on tool use and execution quality rather than a single-shot answer.
...
* [SEC-bench](https://github.com/SEC-bench/SEC-bench) ⭐ 91 | 🐛 3 | 🌐 Python | 📅 2026-01-27 - A benchmark for evaluating LLM agents on real-world software security tasks including vulnerability reproduction and patching, stressing harness design around code execution, containerized environments, and security-aware tooling.
...
* [deepagents](https://github.com/langchain-ai/deepagents) ⭐ 27,892 | 🐛 201 | 🌐 Python | 📅 2026-08-18 - LangChain's open-source project for building deeper, longer-running agents with middleware and harness patterns.

* [SWE-agent](https://github.com/SWE-agent/SWE-agent) ⭐ 20,076 | 🐛 83 | 🌐 Python | 📅 2026-08-17 - A mature research coding agent that makes the harness, prompt, tools, and environment design directly inspectable.

* [browser-use/browser-harness](https://github.com/browser-use/browser-harness) ⭐ 16,757 | 🐛 262 | 🌐 Python | 📅 2026-08-16 - A thin CDP-based browser harness that lets agents extend helper functions during execution, useful for inspecting self-healing web-task workflows.

* [Harbor](https://github.com/harbor-framework/harbor) ⭐ 4,361 | 🐛 718 | 🌐 Python | 📅 2026-08-18 - A generalized harness for evaluating and improving agents at scale, released alongside Terminal-Bench 2.0.
...
* [Citadel](https://github.com/SethGammon/Citadel) ⭐ 904 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-13 - A harness for Claude Code and OpenAI Codex with isolated worktrees, multi-agent coordination, and persisted memory and campaign state.

* [SWE-ReX](https://github.com/SWE-agent/SWE-ReX) ⭐ 572 | 🐛 52 | 🌐 Python | 📅 2026-08-17 - Sandboxed code execution infrastructure for AI agents, useful when harness work starts to merge into execution runtime design.
